...
/**
 * @brief [LOW-LATENCY] Send data directly to UART TX (blocking via DMA)
 * For use in SLE RX callback to bypass ring buffer scheduling delays.
 * @param data Data buffer
 * @param len Data length
 * @return Bytes actually sent, or 0 if failed
 */
